...
namespace __hlt::ModBus {
    struct Request : hilti::rt::trait::isStruct, hilti::rt::Controllable<Request> {
        ...
        std::optional<hilti::rt::integer::safe<uint16_t>> CRC{};
        void __on_CRC(const hilti::rt::integer::safe<uint16_t>& __dd);
        void __on_0x25_init();
        void __on_0x25_done();
        ...
        inline Request(std::optional<std::optional<hilti::rt::Bytes>> unitID, std::optional<std::optional<hilti::rt::ValueReference<PDU>>> pdu, std::optional<std::optional<hilti::rt::integer::safe<uint16_t>>> CRC);
        template<typename F> void __visit(F _) const { _("unitID", unitID); _("pdu", pdu); _("CRC", CRC); }
    };
    ...
    extern void __hook_Request___on_0x25_done_a231(hilti::rt::ValueReference<Request>& __self);
    ...
    extern void __hook_Request___on_CRC(const hilti::rt::integer::safe<uint16_t>& __dd, hilti::rt::ValueReference<__hlt::ModBus::Request>& __self);
...
namespace __hlt::type_info { namespace {
    ...
    const hilti::rt::TypeInfo __ti_ModBus_Request = { "ModBus::Request", "ModBus::Request", new hilti::rt::type_info::Struct(std::vector<hilti::rt::type_info::struct_::Field>({hilti::rt::type_info::struct_::Field{ "unitID", &hilti::rt::type_info::bytes, offsetof(ModBus::Request, unitID), false, hilti::rt::type_info::struct_::Field::accessor_optional<hilti::rt::Bytes>() }, hilti::rt::type_info::struct_::Field{ "pdu", &type_info::__ti_value_refx30ModBus_PDU, offsetof(ModBus::Request, pdu), false, hilti::rt::type_info::struct_::Field::accessor_optional<hilti::rt::ValueReference<__hlt::ModBus::PDU>>() }, hilti::rt::type_info::struct_::Field{ "CRC", &hilti::rt::type_info::uint16, offsetof(ModBus::Request, CRC), false, hilti::rt::type_info::struct_::Field::accessor_optional<hilti::rt::integer::safe<uint16_t>>() }, hilti::rt::type_info::struct_::Field{ "__sink", &type_info::__ti_spicy_rt_SinkState, offsetof(ModBus::Request, __sink), true }, hilti::rt::type_info::struct_::Field{ "__filters", &type_info::__ti_strong_refx30spicy_rt_Filters, offsetof(ModBus::Request, __filters), true }})) };
...
namespace __hlt::ModBus {
    ...
    inline Request::Request(std::optional<std::optional<hilti::rt::Bytes>> unitID, std::optional<std::optional<hilti::rt::ValueReference<__hlt::ModBus::PDU>>> pdu, std::optional<std::optional<hilti::rt::integer::safe<uint16_t>>> CRC) : Request() {
...
auto __hlt::ModBus::Data::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    try {
        HILTI_RT_DEBUG(std::string("spicy"), std::string("ModBus::Data"));
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("modbusv3.spicy:38:13-41:2");
        (*__self).__on_0x25_init();

        // Begin parsing production: Variable: address_3 -> int<16>;
        spicy::rt::detail::printParserState(std::string("ModBus::Data"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: address_3 -> int<16>"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("modbusv3.spicy:39:14"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("address = %s"), hilti::rt::optional::value((*__self).address, "modbusv3.spicy:39:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'address' to '%s'"), hilti::rt::optional::value((*__self).address, "modbusv3.spicy:39:5")));
          __location__("modbusv3.spicy:39:5");
        (*__self).__on_address(hilti::rt::optional::value((*__self).address, "modbusv3.spicy:39:5"));

        // Begin parsing production: Variable: count_3 -> int<16>;
        spicy::rt::detail::printParserState(std::string("ModBus::Data"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: count_3 -> int<16>"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("modbusv3.spicy:40:12"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("count = %s"), hilti::rt::optional::value((*__self).count, "modbusv3.spicy:39:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'count' to '%s'"), hilti::rt::optional::value((*__self).count, "modbusv3.spicy:39:5")));
          __location__("modbusv3.spicy:40:5");
        (*__self).__on_count(hilti::rt::optional::value((*__self).count, "modbusv3.spicy:39:5"));
          __location__("modbusv3.spicy:38:13-41:2");
...
extern auto __hlt::ModBus::Data::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur, const std::optional<spicy::rt::UnitContext>& context) -> hilti::rt::stream::View {
    ...
    spicy::rt::detail::printParserState(std::string("ModBus::Data"), data, ncur, lahead, lahead_end, std::string("default"), hilti::rt::Bool(true));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_Data_3 -> address_3 count_3"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
...
auto __hlt::ModBus::DataWMC::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    try {
        ...
        HILTI_RT_DEBUG(std::string("spicy"), std::string("ModBus::DataWMC"));
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("modbusv3.spicy:43:16-46:2");
        (*__self).__on_0x25_init();
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::DataWMC"), __data, __limited, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: address_4 -> bytes"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        ...
        if ( __limited.offset() != __ncur.offset() ) {
            (*__self).address.reset();
              __location__("modbusv3.spicy:44:20");
            throw spicy::rt::ParseError(std::string("&size amount not consumed"), "modbusv3.spicy:44:20");
        }

        __cur = __ncur;
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("address = %s"), hilti::rt::optional::value((*__self).address, "modbusv3.spicy:44:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'address' to '%s'"), hilti::rt::optional::value((*__self).address, "modbusv3.spicy:44:5")));
          __location__("modbusv3.spicy:44:5");
        (*__self).__on_address(hilti::rt::optional::value((*__self).address, "modbusv3.spicy:44:5"));
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::DataWMC"), __data, __limited_2, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: count_4 -> bytes"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        ...
        if ( __limited_2.offset() != __ncur_2.offset() ) {
            (*__self).count.reset();
              __location__("modbusv3.spicy:45:18");
            throw spicy::rt::ParseError(std::string("&size amount not consumed"), "modbusv3.spicy:45:18");
        }

        __cur = __ncur_2;
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("count = %s"), hilti::rt::optional::value((*__self).count, "modbusv3.spicy:44:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'count' to '%s'"), hilti::rt::optional::value((*__self).count, "modbusv3.spicy:44:5")));
          __location__("modbusv3.spicy:45:5");
        (*__self).__on_count(hilti::rt::optional::value((*__self).count, "modbusv3.spicy:44:5"));
          __location__("modbusv3.spicy:43:16-46:2");
        (*__self).__on_0x25_done();
        hilti::rt::debug::dedent(std::string("spicy"));
        __result = std::make_tuple(__cur, __lah, __lahe);
...
extern auto __hlt::ModBus::DataWMC::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur, const std::optional<spicy::rt::UnitContext>& context) -> hilti::rt::stream::View {
    ...
    spicy::rt::detail::printParserState(std::string("ModBus::DataWMC"), data, ncur, lahead, lahead_end, std::string("default"), hilti::rt::Bool(true));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_DataWMC -> address_4 count_4"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
...
auto __hlt::ModBus::DataWMHR::__parse_registerValues_3_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::Vector<hilti::rt::integer::safe<uint16_t>>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    hilti::rt::detail::checkStack();
    std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> __result;
    for ( hilti::rt::integer::safe<uint64_t> __i = hilti::rt::integer::safe<uint64_t>(hilti::rt::optional::value((*__self).registerCount, "modbusv3.spicy:52:28")); static_cast<bool>(__i);  ) {
        __i--;
        hilti::rt::integer::safe<uint16_t> __elem;

        // Begin parsing production: Variable: uintx3016_3 -> uint<16> (container 'registerValues');
        spicy::rt::detail::printParserState(std::string("ModBus::DataWMHR"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: uintx3016_3 -> uint<16> (container 'registerValues')"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("modbusv3.spicy:52:21"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- got container item"));
        if ( ! (__stop) ) {
              __location__("modbusv3.spicy:52:5");
...
auto __hlt::ModBus::DataWMHR::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> __result;
    try {
        HILTI_RT_DEBUG(std::string("spicy"), std::string("ModBus::DataWMHR"));
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("modbusv3.spicy:48:17-53:2");
        (*__self).__on_0x25_init();

        // Begin parsing production: Variable: registerAddress_3 -> uint<16>;
        spicy::rt::detail::printParserState(std::string("ModBus::DataWMHR"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: registerAddress_3 -> uint<16>"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("modbusv3.spicy:49:22"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("registerAddress = %s"), hilti::rt::optional::value((*__self).registerAddress, "modbusv3.spicy:49:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'registerAddress' to '%s'"), hilti::rt::optional::value((*__self).registerAddress, "modbusv3.spicy:49:5")));
          __location__("modbusv3.spicy:49:5");
        (*__self).__on_registerAddress(hilti::rt::optional::value((*__self).registerAddress, "modbusv3.spicy:49:5"));

        // Begin parsing production: Variable: registerCount_3 -> uint<16>;
        spicy::rt::detail::printParserState(std::string("ModBus::DataWMHR"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: registerCount_3 -> uint<16>"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("modbusv3.spicy:50:20"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("registerCount = %s"), hilti::rt::optional::value((*__self).registerCount, "modbusv3.spicy:49:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'registerCount' to '%s'"), hilti::rt::optional::value((*__self).registerCount, "modbusv3.spicy:49:5")));
          __location__("modbusv3.spicy:50:5");
        (*__self).__on_registerCount(hilti::rt::optional::value((*__self).registerCount, "modbusv3.spicy:49:5"));

        // Begin parsing production: Variable: byteCount_3 -> uint<8>;
        spicy::rt::detail::printParserState(std::string("ModBus::DataWMHR"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: byteCount_3 -> uint<8>"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{1u}, std::string("expecting 1 bytes for unpacking value"), std::string("modbusv3.spicy:51:16"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("byteCount = %s"), hilti::rt::optional::value((*__self).byteCount, "modbusv3.spicy:49:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'byteCount' to '%s'"), hilti::rt::optional::value((*__self).byteCount, "modbusv3.spicy:49:5")));
          __location__("modbusv3.spicy:51:5");
        (*__self).__on_byteCount(hilti::rt::optional::value((*__self).byteCount, "modbusv3.spicy:49:5"));

        // Begin parsing production: Counter: registerValues_3 -> counter(self.registerCount): uintx3016_3;
        spicy::rt::detail::printParserState(std::string("ModBus::DataWMHR"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Counter: registerValues_3 -> counter(self.registerCount): uintx3016_3"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        ...
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("registerValues = %s"), hilti::rt::optional::value((*__self).registerValues, "modbusv3.spicy:49:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'registerValues' to '%s'"), hilti::rt::optional::value((*__self).registerValues, "modbusv3.spicy:49:5")));
          __location__("modbusv3.spicy:52:5");
        (*__self).__on_registerValues(hilti::rt::optional::value((*__self).registerValues, "modbusv3.spicy:49:5"));
          __location__("modbusv3.spicy:48:17-53:2");
        (*__self).__on_0x25_done();
        hilti::rt::debug::dedent(std::string("spicy"));
        __result = std::make_tuple(__cur, __lah, __lahe);
...
extern auto __hlt::ModBus::DataWMHR::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur, const std::optional<spicy::rt::UnitContext>& context) -> hilti::rt::stream::View {
    ...
    spicy::rt::detail::printParserState(std::string("ModBus::DataWMHR"), data, ncur, lahead, lahead_end, std::string("default"), hilti::rt::Bool(true));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_DataWMHR_3 -> registerAddress_3 registerCount_3 byteCount_3 registerValues_3"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
...
auto __hlt::ModBus::PDU::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> __result;
    try {
        HILTI_RT_DEBUG(std::string("spicy"), std::string("ModBus::PDU"));
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("modbusv3.spicy:24:12-36:2");
        (*__self).__on_0x25_init();
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __limited, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: actionCode_2 -> int<8>"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
        spicy::rt::detail::waitForInput(__data, __limited, hilti::rt::integer::safe<std::uint64_t>{1u}, std::string("expecting 1 bytes for unpacking value"), std::string("modbusv3.spicy:25:17"), hilti::rt::StrongReference<spicy::rt::filter::detail::Filters>());
        ...
        if ( __limited.offset() != __ncur.offset() ) {
            (*__self).actionCode.reset();
              __location__("modbusv3.spicy:25:22");
            throw spicy::rt::ParseError(std::string("&size amount not consumed"), "modbusv3.spicy:25:22");
        }
        ...
        __cur = __ncur;
        HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("actionCode = %s"), hilti::rt::optional::value((*__self).actionCode, "modbusv3.spicy:25:5")));
        HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'actionCode' to '%s'"), hilti::rt::optional::value((*__self).actionCode, "modbusv3.spicy:25:5")));
          __location__("modbusv3.spicy:25:5");
        (*__self).__on_actionCode(hilti::rt::optional::value((*__self).actionCode, "modbusv3.spicy:25:5"));
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Switch: switch_2 -> [ActionCode::RC] -> switch_2_case_1 | [ActionCode::RDI] -> switch_2_case_2 | [ActionCode::RHR] -> switch_2_case_3 | [ActionCode::RIR] -> switch_2_case_4 | [ActionCode::WSC] -> switch_2_case_5 | [ActionCode::WSHR] -> switch_2_case_6 | [ActionCode::WMC] -> switch_2_case_7 | [ActionCode::WMHR] -> switch_2_case_8"));
        hilti::rt::debug::indent(std::string("spicy-verbose"));
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_1_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_Data_2 -> address_2 count_2"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    hilti::rt::optional::valueOrInit((*__self).rc) = (__hlt::ModBus::Data());
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).rc, "modbusv3.spicy:27:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_Data_2 -> address_2 count_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("rc = %s"), hilti::rt::optional::value((*__self).rc, "modbusv3.spicy:27:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'rc' to '%s'"), hilti::rt::optional::value((*__self).rc, "modbusv3.spicy:27:30")));
      __location__("modbusv3.spicy:27:30");
    (*__self).__on_rc(hilti::rt::optional::value((*__self).rc, "modbusv3.spicy:27:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_2_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).rdi, "modbusv3.spicy:28:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_Data_2 -> address_2 count_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("rdi = %s"), hilti::rt::optional::value((*__self).rdi, "modbusv3.spicy:28:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'rdi' to '%s'"), hilti::rt::optional::value((*__self).rdi, "modbusv3.spicy:28:30")));
      __location__("modbusv3.spicy:28:30");
    (*__self).__on_rdi(hilti::rt::optional::value((*__self).rdi, "modbusv3.spicy:28:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_3_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).rhr, "modbusv3.spicy:29:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_Data_2 -> address_2 count_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("rhr = %s"), hilti::rt::optional::value((*__self).rhr, "modbusv3.spicy:29:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'rhr' to '%s'"), hilti::rt::optional::value((*__self).rhr, "modbusv3.spicy:29:30")));
      __location__("modbusv3.spicy:29:30");
    (*__self).__on_rhr(hilti::rt::optional::value((*__self).rhr, "modbusv3.spicy:29:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_4_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).rir, "modbusv3.spicy:30:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_Data_2 -> address_2 count_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("rir = %s"), hilti::rt::optional::value((*__self).rir, "modbusv3.spicy:30:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'rir' to '%s'"), hilti::rt::optional::value((*__self).rir, "modbusv3.spicy:30:30")));
      __location__("modbusv3.spicy:30:30");
    (*__self).__on_rir(hilti::rt::optional::value((*__self).rir, "modbusv3.spicy:30:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_5_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).wsc, "modbusv3.spicy:31:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_Data_2 -> address_2 count_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("wsc = %s"), hilti::rt::optional::value((*__self).wsc, "modbusv3.spicy:31:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'wsc' to '%s'"), hilti::rt::optional::value((*__self).wsc, "modbusv3.spicy:31:30")));
      __location__("modbusv3.spicy:31:30");
    (*__self).__on_wsc(hilti::rt::optional::value((*__self).wsc, "modbusv3.spicy:31:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_6_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).wshr, "modbusv3.spicy:32:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_Data_2 -> address_2 count_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("wshr = %s"), hilti::rt::optional::value((*__self).wshr, "modbusv3.spicy:32:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'wshr' to '%s'"), hilti::rt::optional::value((*__self).wshr, "modbusv3.spicy:32:30")));
      __location__("modbusv3.spicy:32:30");
    (*__self).__on_wshr(hilti::rt::optional::value((*__self).wshr, "modbusv3.spicy:32:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_7_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_DataWMHR_2 -> registerAddress_2 registerCount_2 byteCount_2 registerValues_2"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    hilti::rt::optional::valueOrInit((*__self).wmc) = (__hlt::ModBus::DataWMHR());
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).wmc, "modbusv3.spicy:33:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_DataWMHR_2 -> registerAddress_2 registerCount_2 byteCount_2 registerValues_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("wmc = %s"), hilti::rt::optional::value((*__self).wmc, "modbusv3.spicy:33:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'wmc' to '%s'"), hilti::rt::optional::value((*__self).wmc, "modbusv3.spicy:33:30")));
      __location__("modbusv3.spicy:33:30");
    (*__self).__on_wmc(hilti::rt::optional::value((*__self).wmc, "modbusv3.spicy:33:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_case_8_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).wmhr, "modbusv3.spicy:34:30")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_DataWMHR_2 -> registerAddress_2 registerCount_2 byteCount_2 registerValues_2;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("wmhr = %s"), hilti::rt::optional::value((*__self).wmhr, "modbusv3.spicy:34:30")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'wmhr' to '%s'"), hilti::rt::optional::value((*__self).wmhr, "modbusv3.spicy:34:30")));
      __location__("modbusv3.spicy:34:30");
    (*__self).__on_wmhr(hilti::rt::optional::value((*__self).wmhr, "modbusv3.spicy:34:30"));
    __result = std::make_tuple(__cur, __lah, __lahe);
    return __result;
}
...
auto __hlt::ModBus::PDU::__parse_switch_2_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe, hilti::rt::ValueReference<__hlt::ModBus::PDU>& __dst) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> __result;
    hilti::rt::debug::indent(std::string("spicy"));
      __location__("modbusv3.spicy:26:5-35:7");
    if ( const auto __x = hilti::rt::optional::value((*__self).actionCode, "modbusv3.spicy:26:14"); __x == ModBus::ActionCode::RC ) {
          __location__("modbusv3.spicy:26:33-27:41");

        // Begin parsing production: Sequence: switch_2_case_1 -> ModBus_Data_2;
          __location__("modbusv3.spicy:26:33-27:41");
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:26:33-27:41");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_1 -> ModBus_Data_2"));
          __location__("modbusv3.spicy:26:33-27:41");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:26:33-27:41");
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:27:41-28:41");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_2 -> ModBus_Data_2"));
          __location__("modbusv3.spicy:27:41-28:41");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:27:41-28:41");
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:28:41-29:41");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_3 -> ModBus_Data_2"));
          __location__("modbusv3.spicy:28:41-29:41");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:28:41-29:41");
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:29:41-30:41");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_4 -> ModBus_Data_2"));
          __location__("modbusv3.spicy:29:41-30:41");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:29:41-30:41");
        ...
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:30:41-31:41");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_5 -> ModBus_Data_2"));
          __location__("modbusv3.spicy:30:41-31:41");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:30:41-31:41");
        ...
        // End parsing production: Sequence: switch_2_case_5 -> ModBus_Data_2;
          ...
          __location__("modbusv3.spicy:31:41-32:41");

        // Begin parsing production: Sequence: switch_2_case_6 -> ModBus_Data_2;
          __location__("modbusv3.spicy:31:41-32:41");
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:31:41-32:41");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_6 -> ModBus_Data_2"));
          __location__("modbusv3.spicy:31:41-32:41");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:31:41-32:41");
        ...
        // End parsing production: Sequence: switch_2_case_6 -> ModBus_Data_2;
          ...
          __location__("modbusv3.spicy:32:41-33:45");

        // Begin parsing production: Sequence: switch_2_case_7 -> ModBus_DataWMHR_2;
          __location__("modbusv3.spicy:32:41-33:45");
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:32:41-33:45");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_7 -> ModBus_DataWMHR_2"));
          __location__("modbusv3.spicy:32:41-33:45");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:32:41-33:45");
        ...
        // End parsing production: Sequence: switch_2_case_7 -> ModBus_DataWMHR_2;
          ...
          __location__("modbusv3.spicy:33:45-34:45");

        // Begin parsing production: Sequence: switch_2_case_8 -> ModBus_DataWMHR_2;
          __location__("modbusv3.spicy:33:45-34:45");
        spicy::rt::detail::printParserState(std::string("ModBus::PDU"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
          __location__("modbusv3.spicy:33:45-34:45");
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Sequence: switch_2_case_8 -> ModBus_DataWMHR_2"));
          __location__("modbusv3.spicy:33:45-34:45");
        hilti::rt::debug::indent(std::string("spicy-verbose"));
          __location__("modbusv3.spicy:33:45-34:45");
        ...
        // End parsing production: Sequence: switch_2_case_8 -> ModBus_DataWMHR_2;
          ...
          __location__("modbusv3.spicy:26:5-35:7");
        throw spicy::rt::ParseError(std::string("no matching case in switch statement"), "modbusv3.spicy:26:5-35:7");
    }
...
extern auto __hlt::ModBus::PDU::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur, const std::optional<spicy::rt::UnitContext>& context) -> hilti::rt::stream::View {
    ...
    spicy::rt::detail::printParserState(std::string("ModBus::PDU"), data, ncur, lahead, lahead_end, std::string("default"), hilti::rt::Bool(true));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_PDU_2 -> actionCode_2 switch_2"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
...
inline void __hlt::ModBus::Request::__on_CRC(const hilti::rt::integer::safe<uint16_t>& __dd) {
    auto __self = ModBus::Request::__self();
    return __hlt::ModBus::__hook_Request___on_CRC(__dd, __self);
}
...
auto __hlt::ModBus::Request::__parse_ModBus_Request_stage2(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    spicy::rt::detail::printParserState(std::string("ModBus::Request"), __data, __limited, __lah, __lahe, std::string("default"), __trim);
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: unitID -> bytes"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    spicy::rt::detail::waitForEod(__data, __limited, (*__self).__filters);
    hilti::rt::optional::valueOrInit((*__self).unitID) = __limited.data();
    __limited = __limited.advance(__limited.size());
    if ( __trim ) {
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- trimming input"));
        (*__data).trim(__limited.begin());
    ...
    __cur = __ncur;
    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("unitID = %s"), hilti::rt::optional::value((*__self).unitID, "modbusv3.spicy:18:5")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'unitID' to '%s'"), hilti::rt::optional::value((*__self).unitID, "modbusv3.spicy:18:5")));
      __location__("modbusv3.spicy:18:5");
    (*__self).__on_unitID(hilti::rt::optional::value((*__self).unitID, "modbusv3.spicy:18:5"));

    // Begin parsing production: Unit: ModBus_PDU -> actionCode switch;
    spicy::rt::detail::printParserState(std::string("ModBus::Request"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_PDU -> actionCode switch"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    hilti::rt::optional::valueOrInit((*__self).pdu) = (__hlt::ModBus::PDU());
    std::tie(__cur, __lah, __lahe) = (*hilti::rt::optional::value((*__self).pdu, "modbusv3.spicy:18:5")).__parse_stage1(__data, __cur, __trim, __lah, __lahe);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_PDU -> actionCode switch;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("pdu = %s"), hilti::rt::optional::value((*__self).pdu, "modbusv3.spicy:18:5")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'pdu' to '%s'"), hilti::rt::optional::value((*__self).pdu, "modbusv3.spicy:18:5")));
      __location__("modbusv3.spicy:19:5");
    (*__self).__on_pdu(hilti::rt::optional::value((*__self).pdu, "modbusv3.spicy:18:5"));

    // Begin parsing production: Variable: CRC -> uint<16>;
    spicy::rt::detail::printParserState(std::string("ModBus::Request"), __data, __cur, __lah, __lahe, std::string("default"), __trim);
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Variable: CRC -> uint<16>"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    spicy::rt::detail::waitForInput(__data, __cur, hilti::rt::integer::safe<std::uint64_t>{2u}, std::string("expecting 2 bytes for unpacking value"), std::string("modbusv3.spicy:20:10"), (*__self).__filters);
    std::tie(hilti::rt::optional::valueOrInit((*__self).CRC), __cur) = hilti::rt::integer::unpack<uint16_t>(__cur, hilti::rt::ByteOrder::Network).valueOrThrow();
    if ( __trim ) {
        HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- trimming input"));
        (*__data).trim(__cur.begin());
    }
    ...
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Variable: CRC -> uint<16>;

    HILTI_RT_DEBUG(std::string("spicy"), hilti::rt::fmt(std::string("CRC = %s"), hilti::rt::optional::value((*__self).CRC, "modbusv3.spicy:18:5")));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), hilti::rt::fmt(std::string("- setting field 'CRC' to '%s'"), hilti::rt::optional::value((*__self).CRC, "modbusv3.spicy:18:5")));
      __location__("modbusv3.spicy:20:5");
    (*__self).__on_CRC(hilti::rt::optional::value((*__self).CRC, "modbusv3.spicy:18:5"));
      __location__("modbusv3.spicy:14:23-22:2");
    (*__self).__on_0x25_done();
...
auto __hlt::ModBus::Request::__parse_stage1(hilti::rt::ValueReference<hilti::rt::Stream>& __data, hilti::rt::stream::View __cur, hilti::rt::Bool __trim, hilti::rt::integer::safe<int64_t> __lah, hilti::rt::stream::SafeConstIterator __lahe) -> std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> {
    ...
    std::tuple<hilti::rt::stream::View, hilti::rt::integer::safe<int64_t>, hilti::rt::stream::SafeConstIterator> __result;
    try {
        HILTI_RT_DEBUG(std::string("spicy"), std::string("ModBus::Request"));
        hilti::rt::debug::indent(std::string("spicy"));
          __location__("modbusv3.spicy:14:23-22:2");
        (*__self).__on_0x25_init();
...
extern auto __hlt::ModBus::Request::parse1(hilti::rt::ValueReference<hilti::rt::Stream>& data, const std::optional<hilti::rt::stream::View>& cur, const std::optional<spicy::rt::UnitContext>& context) -> hilti::rt::stream::View {
    ...
    // Begin parsing production: Unit: ModBus_Request -> unitID ModBus_PDU CRC;
    spicy::rt::detail::printParserState(std::string("ModBus::Request"), data, ncur, lahead, lahead_end, std::string("default"), hilti::rt::Bool(true));
    HILTI_RT_DEBUG(std::string("spicy-verbose"), std::string("- parsing production: Unit: ModBus_Request -> unitID ModBus_PDU CRC"));
    hilti::rt::debug::indent(std::string("spicy-verbose"));
    std::tie(ncur, lahead, lahead_end) = (*unit).__parse_stage1(data, ncur, hilti::rt::Bool(true), lahead, lahead_end);
    hilti::rt::debug::dedent(std::string("spicy-verbose"));
    // End parsing production: Unit: ModBus_Request -> unitID ModBus_PDU CRC;
...
extern void __hlt::ModBus::__hook_Request___on_0x25_done_a231(hilti::rt::ValueReference<Request>& __self) {
    hilti::rt::detail::checkStack();
      __location__("modbusv3.spicy:21:16");
