...
//   - ModBus (/home/sol/spicy/modbusv3.spicy)
...
namespace __hlt::ModBus {
    ...
    void __hook_Request___on_CRC(const hilti::rt::integer::safe<uint16_t>& __dd, hilti::rt::ValueReference<__hlt::ModBus::Request>& __self);
...
const char HILTI_EXPORT HILTI_WEAK * __hlto_library_version = R"({"created":1632216216.734979,"debug":true,"hilti_version":10200,"magic":"v1","optimize":false})";
const char HILTI_WEAK * __hlto_scope = "eb54f9";
...
extern void __hlt::ModBus::__hook_Request___on_0x25_done(hilti::rt::ValueReference<Request>& __self) { __hlt::ModBus::__hook_Request___on_0x25_done_a231(__self); }
...
void __hlt::ModBus::__hook_Request___on_CRC(const hilti::rt::integer::safe<uint16_t>& __dd, hilti::rt::ValueReference<__hlt::ModBus::Request>& __self) {  }
